...
/**
 * Extends Playwright's base `test` with one fixture per page object, so
 * specs consume ready-to-use page objects instead of constructing them by
 * hand in every test (https://playwright.dev/docs/pom, "Page objects").
 */
